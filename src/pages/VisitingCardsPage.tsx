      ...
      <div className="max-w-4xl mx-auto px-6 mt-14">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside font-ui text-sm text-gray-700 space-y-1 mb-4">
            <li>Size: 95mm × 58mm (includes 3mm bleed on all sides)</li>
            <li>Resolution: 300 DPI minimum</li>
            <li>Colour mode: CMYK</li>
            <li>Format: PDF preferred, or AI, PSD, PNG</li>
          </ul>
          <a
            href={`${BUSINESS.whatsapp}?text=${encodeURIComponent("Hi! I'd like the visiting card print template (PDF/AI). Please send.")}`}
            target="_blank"
            rel="noopener noreferrer"
