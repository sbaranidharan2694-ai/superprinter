export const BUSINESS = {
  name: "Super Printers",
  tagline: "Best Printing Press in Pallavaram, Chennai Since 1990",
  phone: "+91 9840199878",
...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  "description": "Super Printers is a leading printing press in Pallavaram, Chennai established in 1990. We offer offset printing, digital printing, visiting cards, banners, brochures, bill books, rubber stamps, T-shirt printing, invitation cards, stickers, letterheads and all commercial printing services.",
  "url": BUSINESS.siteUrl,
  "telephone": BUSINESS.phone,
  "email": BUSINESS.email,
  "image": `${BUSINESS.siteUrl}/og-image.jpg`,
  "logo": `${BUSINESS.siteUrl}/logo.svg`,
  "priceRange": "₹₹",
  ...
  "hasOfferCatalog": {
    ...
    "itemListElement": [
      ...
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Pamphlet Printing" } },
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "PVC ID Card Printing" } },
    ],
  },
};
...
export const FAQ_SCHEMA = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Super Printers has been a trusted printing press in Chennai since 1990, serving customers in Pallavaram, Chromepet, Tambaram and across Chennai with high-quality printing at competitive prices.",
      },
    },
  ],
};
