...
const BY_SERVICE: Record<string, ServiceFaqItem[]> = {
  ...
  "wedding-invitations": [
    ...
    { name: "How long do wedding cards take?", acceptedAnswer: { text: "Typically 24–48 hours after proof approval. Urgent same-day orders may be possible—ask on WhatsApp." } },
