    ...
    <section className="relative min-h-[100svh] min-h-[700px] flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="relative z-10 flex-1 min-h-[60vh] lg:min-h-[100svh] flex items-center px-6 sm:px-12 lg:px-20 py-20 lg:py-24" style={{ minHeight: "min(100svh, 700px)" }}>
        <div className="max-w-xl">
          ...
          >
            <span className="inline-flex items-center gap-1.5 text-ink-black font-ui text-sm sm:text-base font-medium tracking-wide">
          ...
          <motion.h1
            ...
            className="hero-h1 text-ink-black mb-8"
            style={{
          ...
          >
            ...
            <span className="block text-ink-black">Print Studio.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4, delay: 0.7 }}
            className="font-ui text-lg max-w-[460px] mb-8 leading-[1.7] text-gray-700"
          >
          ...
          >
            ...
            <button
              ...
              className="border-2 border-navy text-navy font-ui font-medium text-base px-8 py-3.5 rounded-full hover:bg-navy hover:text-white transition-all duration-300 ease-spring"
            >
              {t("View Our Products")} →
            </button>
          </motion.div>
          <motion.button
            ...
            className="text-gray-600 hover:text-ink-black font-ui text-sm font-medium flex items-center gap-2 mb-8 transition-colors"
          >
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="flex items-center gap-2 text-sm font-ui text-gray-600"
          >
      ...
      >
        <button
          onClick={() => scrollToSection("products")}
          className="flex flex-col items-center text-gray-500 hover:text-ink-black transition-colors"
