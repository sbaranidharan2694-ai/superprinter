    ...
    <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32 w-full">
      <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-3">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }} className="text-base leading-relaxed mb-8 max-w-lg" style={{ color: "#4B5563", fontFamily: "var(--font-body)", whiteSpace: "pre-line" }}>{HERO.body}</motion.p>
