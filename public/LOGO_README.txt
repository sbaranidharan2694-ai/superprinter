Logo (header + footer only; no duplicate in hero):
  ...
  • super-printers-logo.png — YOUR BRAND LOGO. Save your full Super Printers image (hexagon SP,
    ...
    in the public/ folder. Used in navbar (and footer if added). The site loads this PNG first.
  • super-printers-logo.svg — fallback when PNG is missing or fails to load.
